...
public class BluetoothSerialService {
    ...
    private void connectionFailed() {
        ...
        Bundle bundle = new Bundle();
        bundle.putString(main_activity.TOAST, mContext.getString(R.string.toast_unable_to_connect) );
        msg.setData(bundle);
        mHandler.sendMessage(msg);
    }
    ...
    private void connectionLost() {
        ...
        Message msg = mHandler.obtainMessage(main_activity.MESSAGE_TOAST);
        Bundle bundle = new Bundle();
        bundle.putString(main_activity.TOAST, mContext.getString(R.string.toast_connection_lost) );
        msg.setData(bundle);
        mHandler.sendMessage(msg);
    }
...
//                    mEmulatorView.write(buffer, bytes);
        ...
        public void write(byte[] buffer) {
            try {
                ...
                mHandler.obtainMessage(main_activity.MESSAGE_WRITE, buffer.length, -1, buffer)
                        .sendToTarget();
            } catch (IOException e) {
